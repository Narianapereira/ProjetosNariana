...
public class Treinamento {
	...
	public static void verificaIndice(double imc) {
		...
		if (imc < 17) {
			JOptionPane.showMessageDialog(null, "Você está muito abaixo do seu peso! Índice: " + imc);
		} else if (imc == 17 || imc < 18.49) {
			JOptionPane.showMessageDialog(null, "Você está abaixo do peso! Índice: " + imc);
		} else if (imc < 24.99) {
			JOptionPane.showMessageDialog(null, "Você está com um peso adequado! Índice: " + imc);
		} else if (imc < 29.99) {
	...
	public static void mostraErroAltura() {
		JOptionPane.showMessageDialog(null, "A altura é inválida");
	}
}
