...
public class L1Ex8 {
	...
	public static void main(String[] args) {
		 ...
		 */
		/*
		 * variáveis reais. Uma matriz para os valores das vendas Um vetor para os
...
// contadora para armazenar os valores fornecidos na matriz.
		for (int l = 0; l < 6; l++) {
			for (int c = 0; c < 4; c++) {
				...
				valores[l][c] = Double.parseDouble(JOptionPane
						.showInputDialog("Digite o valor da " + (c + 1) + "ª semana na " + (l + 1) + " mês."));
		...
		for (int l = 0; l < 6; l++) {
			JOptionPane.showMessageDialog(null, "O total vendido no " + (l + 1) + " mês foi de R$ " + df.format(valorMensal[l]));
		}
	}
}